...
constexpr double dt = 1.0e-10;//1.0e-11;  // time step size
...
const int    BOUNDTYPE = 3; // Boundary type for the fixed temp is 1 reflected energy i1 2, and background is 0, 3 do nothing
...
const double SCALE=0.01;// Scaling factor for the diagonal term in the matrix
const double EMISSCALE=10.0; // Scaling factor for the emission term